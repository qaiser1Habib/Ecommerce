										...
										>
											...
											<div className="tp-login-input-wrapper">
												...
												<div className="tp-login-input-box">
													...
													<div onClick={handleShowPassword} className="tp-login-input-eye" id="password-show-toggle">
														{showPass ? (
															<span id="open-eye">
																<svg
																	width={18}
												...
												{errors.password && <p className="text-danger ms-4"> {errors?.password?.message}</p>}
												<div className="tp-login-input-box">
													<div className="tp-login-input">
														<input
															id="confirmPassword"
