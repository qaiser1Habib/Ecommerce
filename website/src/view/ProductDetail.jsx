								...
								<nav>
									...
									>
										...
										<span
											...
											style={{ left: 451, display: "block", width: 78 }}
										/>
									</div>
								</nav>
														...
														<div className="row">
															<div className="col-lg-6">
																<div className="tp-product-details-desc-content pt-25">
																	...
																	<h3 className="tp-product-details-desc-title">Your world at a glance</h3>
																	<p>
																		With a slim design, a vibrant entertainment system, and <br /> outstanding
																		performance, the new Galaxy Tab A7 is a stylish new <br /> companion for
																		your life.Dive head-first into the things you love, <br /> and easily share
																		your favorite moments. Learn, explore, connect <br /> and be inspired.
																	</p>
																</div>
														...
														<div className="row">
															...
															<div className="col-lg-5 order-first order-lg-last">
																<div className="tp-product-details-desc-content des-content-2 pl-40">
																	...
																	<p>
																		Wrap your tablet in a sleek case that's as stylish as it is convenient.
																		Galaxy Tab S6 Lite Book Cover folds around and clings magnetically, so you
																		can easily gear up as you're headed out the door. There's even a compartment
																		for S pen, so you can be sure it doesn't get left behind.
																	</p>
																</div>
															</div>
														</div>
														...
														<div className="tp-product-details-review-list pr-110">
															...
															<div className="tp-product-details-review-avater d-flex align-items-start">
																...
																<div className="tp-product-details-review-avater-content">
																	...
																	<div className="tp-product-details-review-avater-comment">
																		<p>
																			Designed very similarly to the nearly double priced Galaxy tab S6, with
																			the only removal being.
																		</p>
																	</div>
																</div>
															</div>
															<div className="tp-product-details-review-avater d-flex align-items-start">
																...
																<div className="tp-product-details-review-avater-content">
																	...
																	<div className="tp-product-details-review-avater-comment">
																		<p>
																			This review is for the Samsung Tab S6 Lite, 64gb wifi in blue. purchased
