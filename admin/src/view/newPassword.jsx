        ...
        <div className="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
          ...
          <div className="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
            ...
            <div className="d-flex flex-stack py-2">
              ...
              <div className="me-2">
                <Link
                  to="/admin-panel/forgot-password"
              ...
              <div className="m-0">
                <span
                  ...
                  data-kt-translate="new-password-head-desc"
                >
                  Already a member ?
                </span>
                <Link
              ...
              >
                ...
                <div className="text-start mb-10">
                  ...
                  <h1
                    ...
                    data-kt-translate="new-password-title"
                  >
                    Setup New Password
                  </h1>
                  {/*end::Title*/}
                  ...
                  <div
                    ...
                    data-kt-translate="new-password-desc"
                  >
                ...
                <div className="mb-10 fv-row" data-kt-password-meter="true">
                  ...
                  <div
                    ...
                    data-kt-translate="new-password-hint"
                  >
      ...
      >
        <div className="w-25 h-50" style={{marginBottom:"325px",marginRight:"150px"}}>
          <img
            ...
            src="/assets/adminPanel/media/header/nav-logo.png"
            alt="logo"
          />
        </div>
      </div>
