							...
							<div className="row">
								<div className="d-flex flex-wrap flex-stack pt-3">
									<div className="d-flex flex-wrap flex-stack">
										<div className="fw-bolder fs-4 p-4">All DATA</div>
									...
									<div className="card-body py-3 px-3 card-scroll">
										<div className="text-center mb-2">
											<img
												...
												alt=""
												loading="lazy"
												src={"/assets/adminPanel/media/pages/folder_pic.jpg"}
												style={{ objectFit: "cover" }}
											/>
										</div>
										<div className="banner text-dark fw-bold text-center fs-4">
											<Link to="/content-detail" className="text-dark">
												Photo
											</Link>
										</div>
									</div>
